  ...
  head: () => ({
    meta: [
      { title: "Pôle formateur — Rejoindre Skills4mation" },
      {
        name: "description",
        content:
          "Portage administratif et pédagogique pour formateurs indépendants : Qualiopi, conventions, financements OPCO et CPF. Candidatez au réseau Skills4mation.",
      },
...
const ATOUTS = [
  ...
  },
  {
    ...
    texte: "Montage OPCO, CPF, entreprise et suivi des accords de financement.",
  },
  {
    icon: BadgeCheck,
